  ...
  return (
    <section className="relative bg-white min-h-screen flex items-center px-4 sm:px-6 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto flex flex-col items-center text-center gap-5 py-16">
        ...
        {/* Eyebrow */}
        <span className="animate-fade-in-up anim-delay-100 inline-flex items-center gap-2 text-xs font-semibold bg-brand-light text-brand px-4 py-2 rounded-full">
          <span className="w-1.5 h-1.5 rounded-full bg-brand inline-block animate-pulse-dot" />
          AI Product Photography — Launching Soon
        </span>

        {/* Headline */}
        <h1 className="animate-fade-in-up anim-delay-200 text-3xl sm:text-4xl font-bold tracking-tight text-brand-navy leading-[1.15]">
          Skip the model.{" "}
        ...
        {/* Subtext */}
        <p className="animate-fade-in-up anim-delay-300 text-base sm:text-lg text-gray-500 max-w-xl leading-relaxed">
        ...
        {/* Form */}
        <div className="animate-fade-in-up anim-delay-400 w-full flex justify-center">
          <WaitlistForm />
        </div>

        {/* Trust line */}
        <p className="animate-fade-in anim-delay-500 text-xs text-gray-400 flex items-center gap-2">
